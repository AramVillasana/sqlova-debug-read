...
class Seq2SQL_v1(nn.Module):
    ...
    def forward(self, emb_question, len_question, emb_header, len_header_token, number_header,
        ...
        # sc
        s_sc = self.scp(emb_question, len_question, emb_header, len_header_token, number_header, show_p_sc=show_p_sc)
        ...
        # sa
        s_sa = self.sap(emb_question, len_question, emb_header, len_header_token, number_header, pr_sc, show_p_sa=show_p_sa)
        if g_sa:
        ...
        # wn
        s_wn = self.wnp(emb_question, len_question, emb_header, len_header_token, number_header, show_p_wn=show_p_wn)
        ...
        # wc
        s_wc = self.wcp(emb_question, len_question, emb_header, len_header_token, number_header, show_p_wc=show_p_wc, penalty=True)
        ...
        # wo
        s_wo = self.wop(emb_question, len_question, emb_header, len_header_token, number_header, wn=pr_wn, wc=pr_wc, show_p_wo=show_p_wo)
        ...
        # wv
        s_wv = self.wvp(emb_question, len_question, emb_header, len_header_token, number_header, wn=pr_wn, wc=pr_wc, wo=pr_wo, show_p_wv=show_p_wv)
...
class SCP(nn.Module):
    ...
    def forward(self, emb_question, len_question, emb_header, len_header_token, number_header, show_p_sc=False):
        ...
        wenc_hs = encode_header(self.enc_h, emb_header, len_header_token, number_header)  # [b, hs, dim]
        ...
        # Penalty
        mL_hs = max(number_header)
        for b, l_hs1 in enumerate(number_header):
            if l_hs1 < mL_hs:
...
class SAP(nn.Module):
    ...
    def forward(self, wemb_n, l_n, wemb_hpu, l_hpu, l_hs, pr_sc, show_p_sa=False):
        ...
        wenc_hs = encode_header(self.enc_h, wemb_hpu, l_hpu, l_hs)  # [b, hs, dim]
...
class WNP(nn.Module):
    ...
    def forward(self, wemb_n, l_n, wemb_hpu, l_hpu, l_hs, show_p_wn=False):
        ...
        wenc_hs = encode_header(self.enc_h, wemb_hpu, l_hpu, l_hs)  # [b, mL_hs, dim]
